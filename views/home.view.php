...
require_once($_SERVER['DOCUMENT_ROOT'] . '/models/ProductsTable.php');
                        ...
                        <div class="card-body p-4 pb-5">
                            <div class="form-check-inline">
                                <label class="form-check-inline">
                                    <input class="delete-checkbox form-check-input" form="delete-form" type="checkbox"
                                        id="checkbox" name="<?php echo $product->getId(); ?>">
